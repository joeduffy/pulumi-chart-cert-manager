...
return await Deployment.RunAsync(() =>
{
  ...
  // var issuer = new Pulumi.Kubernetes.ApiExtensions.CustomResource("issuer", new CustomResourceArgs
  // {
  ...
  //     { "apiVersion", "cert-manager.io/v1" },
  //     { "kind", "Issuer" },
  //     { "spec", new Dictionary<string, object> { ["selfSigned"] = new Dictionary<string, object>() } }
  //   }
  // }, new CustomResourceOptions { DependsOn = { manager } });

  return new Dictionary<string, object?>
  {
    ["certManagerStatus"] = manager.Status
  };
});
